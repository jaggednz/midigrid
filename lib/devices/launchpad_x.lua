-----------------------------------------------------------------------
-- Launchpad X — Gen 3 SysEx RGB driver
--
-- SysEx device ID: 0x0C
-- Aux: right column (CC 89,79,...,19), top row (CC 91-98)
-- MIDI interface: port 2 (LPX MIDI In/Out)
-----------------------------------------------------------------------
...
launchpad.sysex_device_id = 0x0C

-- Enter Programmer Mode via Programmer/Live toggle
launchpad.init_device_msg = { 0xf0, 0x00, 0x20, 0x29, 0x02, 0x0c, 0x0e, 0x01, 0xf7 }
